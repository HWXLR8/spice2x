...
static const std::vector<OptionDefinition> OPTION_DEFINITIONS = {
    ...
    },
    {
        ...
        .type = OptionType::Bool,
        .hidden = true, // superceded by spice2x_Dx9On12
        .category = "Graphics (Common)",
    },
    {
        // spice2x_Dx9On12
    ...
    },
    {
        ...
        .title = "(REMOVED) EA Maintenance",
        .name = "eamaint",
        .desc = "Enables EA Maintenance, 1 for on, 0 for off. Use -spice2x_EAmusementMaintenance instead",
        .type = OptionType::Enum,
        .hidden = true,
        .category = "Network (Advanced)",
        .elements = {{"0", "Off"}, {"1", "On"}},
    ...
    },
    {
        ...
        .desc = "Default size of the subscreen overlay.\n\nNote: in windoweed mode, subscreen will always be full size.\n\nDefault: medium",
        .type = OptionType::Enum,
        .game_name = "Beatmania IIDX",
        .category = "Overlay",
        .elements = {
    ...
    },
    {
        ...
        .title = "(REMOVED) Disable Touch Card Insert",
        .name = "touchnocard",
    ...
    },
    {
        ...
        .title = "IIDX TDJ Windowed Mode",
        .name = "sp2x-iidxtdjw",
        .desc = "Enable TDJ, optimized for windowed mode. Main window cannot be moved or resized. "
            "Press Toggle Subscreen button and use your mouse on the main window, not on the second window! "
            "This is a convenience option that combines the following into one command for you: "
            "-w -iidxtdj -sp2x-iidxtdjsubsize fullscreen, plus env var SCREEN_MODE set to 4",
        .type = OptionType::Bool,
        .game_name = "Beatmania IIDX",
        .category = "Game Options",
    },
    ...
    },
    {
        ...
        .name = "sp2x-autocard",
        .desc = "Automatically insert card to reader",
        .type = OptionType::Enum,
        .category = "Network",
        .elements = {
            {"off", ""},
    ...
    },
    {
        ...
        "Only applies to IIDX and SDVX for now. Default: mid",
        .type = OptionType::Enum,
        .category = "Lights Options",
        .elements = {
            {"off", "Off"},
